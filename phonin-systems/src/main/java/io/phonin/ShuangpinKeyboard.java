 ...
 * key is exactly a {@link io.phonin.model.Reading}'s toneless syllable. (Mandarin writes ü as plain
 * {@code u} after {@code j/q/x/y} and as {@code v} after {@code l/n}; the keymap follows the same
 * convention.) Codes may contain non-letter keys — e.g. mspy uses {@code ;} for {@code ing} — and
 * are matched verbatim, char by char.
 *
