...
import dev.vfyjxf.phonin.core.AcceleratedQuery;
 ...
 * dev.vfyjxf.phonin.core.AcceleratedQuery} result must equal the equivalent direct {@link PhonIn} call
 * for the same {@link Options}. This pins that invariant across modes, systems, fuzzy, and
 * shuangpin.
 */
