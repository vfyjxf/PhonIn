...
class PreciseSearcherTest {
    ...
    //region correctness: PRECISE disambiguation
    ...
    //endregion
    //region correctness: cross-check vs direct API
    ...
    //endregion
    //region performance: PreciseSearcher vs LinearSearcher
