 ...
 *
 * <p>{@code ./gradlew :phonin-core:test --tests dev.vfyjxf.phonin.PerfBenchmarkTest
 * -Dphonin.bench=true}
 *
 * <p>Parts:
 *
...
class PerfBenchmarkTest {
    ...
    private PhonIn partAEngineFootprint() {
        ...
        System.out.printf("  all 5 systems: %6.1f MB%n", mb(withEngine - empty));
    ...
    //endregion
    //region Part B: direct matcher throughput
    ...
    private void partBDirectMatcher(PhonIn phonIn) {
        ...
        Options shuangpin = MandarinOptions.shuangpin("flypy");
        Options fuzzy =
    ...
    //endregion
    //region Part C: AcceleratedQuery
    ...
    //endregion
    //region Part D: Searcher build + search
