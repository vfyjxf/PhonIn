 ...
 * {@link io.phonin.Matcher} over the same names + {@link Options} + {@link SearcherLogic}. Both
 * {@link SimpleSearcher} and {@link TreeSearcher} are held to this invariant, and to each other,
 * across logics, systems, fuzzy, shuangpin, and abbreviation — and at index sizes large enough to
 * force the trie's {@code NDense}→{@code NSlice}→{@code NMap} self-tuning.
 */
class SearcherTest {
