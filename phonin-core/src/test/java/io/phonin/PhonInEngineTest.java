...
class PhonInEngineTest {
    ...
    void shuangpinMatchesTwoKeyCode() {
        ...
        Options flypy = SystemOptions.mandarinShuangpin("flypy");
        ...
        assertThat(phonIn.matches("中国", "vygo", SystemOptions.mandarinShuangpin("pyjj"))).isTrue();
        assertThat(phonIn.matches("中国", "asgo", SystemOptions.mandarinShuangpin("abc"))).isTrue();
        assertThat(phonIn.matches("中国", "vsgo", SystemOptions.mandarinShuangpin("zrm"))).isTrue();

        // mspy maps finals onto non-letter keys ('ing' -> ';'); 'a' -> 'oa'. Matched verbatim.
        Options mspy = SystemOptions.mandarinShuangpin("mspy");
        ...
        Options spStrict =
                SystemOptions.mandarinShuangpin("flypy").toBuilder()
    ...
    void fuzzyRulesRegisteredByName() {
        ...
        // the bundled dataset char path tolerates a fuzzy option without exception
    ...
    void fuzzyAppliesToSyllableUnderShuangpin() {
        ...
        assertThat(phonIn.contains("中", "zs", SystemOptions.mandarinShuangpin("flypy"))).isFalse();
    }
    ...
    // ---- edge paths: empty text, literal chars, null guards ----------------
