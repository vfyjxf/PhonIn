 ...
 * dev.vfyjxf.phonin.core.search.Searcher}): their speed rests on {@link
 * dev.vfyjxf.phonin.core.match.Accelerator} caching {@code IndexSet}s per codepoint shared across all
 * names, which a name-and-position-dependent restriction breaks. A non-accelerated precise {@code
 * Searcher} is a documented follow-up.
 */
