 ...
 *
 * <p>The predefined block router lives in {@code phonin-core} ({@code ByBlockRouter}). It maps
 * Hangul &rarr; Korean, kana &rarr; Japanese, Bopomofo &rarr; Zhuyin, CJK Han &rarr; a
...
public interface CodepointRouter {
     ...
     * return an empty iterable will not cause any systems to be loaded automatically.
     */
