 ...
 * dev.vfyjxf.phonin.core.elements.Phoneme#match} returns the lengths it can consume, {@link
 * dev.vfyjxf.phonin.core.match.Matcher#check} backtracks over those lengths to chain elements.
 *
