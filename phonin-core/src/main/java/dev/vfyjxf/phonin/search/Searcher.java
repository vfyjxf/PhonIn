 ...
 *
 * <p>Results are correct iff they equal the direct {@link dev.vfyjxf.phonin.core.match.Matcher} over the
 * same names + {@link Options} + {@link SearcherLogic}; Searchers are an optimization, not a
 * semantic change.
 *
