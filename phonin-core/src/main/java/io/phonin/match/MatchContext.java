...
import io.phonin.CodepointRouter;
...
import io.phonin.elements.CharNodes;
...
public final class MatchContext {
     ...
     * io.phonin.search.PreciseSearcher} to pre-compute per-position CharNodes at index time.
     */
