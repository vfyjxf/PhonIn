 ...
 * io.phonin.AcceleratedQuery} and {@link io.phonin.search.Searcher} paths cannot diverge from
 * one-off matching because they share this code path.
 *
...
public final class Accelerator {
    ...
    // ---- whole-name tests against a Provider ----
     ...
     * {@link io.phonin.search.TreeSearcher} trie can resume matching from a partial query offset.
     */
    ...
    // ---- int[] convenience (AcceleratedQuery / SimpleSearcher) ----
