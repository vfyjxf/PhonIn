...
import io.phonin.Keyboard;
import io.phonin.Options;
import io.phonin.TonePolicy;
 ...
 * policy, fuzzy rules, and 简拼 setting. Extracted from {@link io.phonin.match.MatchContext} so node
 * construction is independent of per-call caches and polyphone segmentation state.
 */
