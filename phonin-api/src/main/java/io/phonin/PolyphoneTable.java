...
public final class PolyphoneTable {
     ...
     *
     * <p>Engine-internal: the engine ({@link io.phonin.match.MatchContext}) calls this once per
     * match call. Exposed publicly only because the engine lives in a sibling package; callers
