...
/**
 * A keyboard maps a toneless syllable to the surface string the user types. The bundled {@link
 * #identity} passes the syllable through unchanged (so the system's own romanization / Bopomofo is
 * used); bundled shuangpin keyboards live in the {@code phonin-systems} module ({@code
 * ShuangpinKeyboard}). Implement this interface to plug in a custom keymap.
 *
